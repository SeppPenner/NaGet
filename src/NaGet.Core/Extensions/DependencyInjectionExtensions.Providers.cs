...
{
    private static readonly string DatabaseTypeKey = $"{nameof(NaGetOptions.Database)}:{nameof(DatabaseOptions.Type)}";
    private static readonly string SearchTypeKey = $"{nameof(NaGetOptions.Search)}:{nameof(SearchOptions.Type)}";
    private static readonly string StorageTypeKey = $"{nameof(NaGetOptions.Storage)}:{nameof(StorageOptions.Type)}";
    ...
    public static IServiceCollection AddNaGetDbContextProvider<TContext>(
        this IServiceCollection services,
        string databaseType,
