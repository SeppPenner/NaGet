...
{
    public static IServiceCollection AddNaGetApplication(
        this IServiceCollection services,
        Action<NaGetApplication> configureAction)
    {
        var app = new NaGetApplication(services);

        services.AddConfiguration();
        services.AddNaGetServices();
    ...
    {
        services.AddNaGetOptions<NaGetOptions>();
        services.AddNaGetOptions<DatabaseOptions>(nameof(NaGetOptions.Database));
        services.AddNaGetOptions<FileSystemStorageOptions>(nameof(NaGetOptions.Storage));
        services.AddNaGetOptions<MirrorOptions>(nameof(NaGetOptions.Mirror));
        services.AddNaGetOptions<SearchOptions>(nameof(NaGetOptions.Search));
        services.AddNaGetOptions<StorageOptions>(nameof(NaGetOptions.Storage));
    }

    private static void AddNaGetServices(this IServiceCollection services)
    {
        ...
        services.TryAddTransient<IServiceIndexService, NaGetServiceIndex>();
    ...
    private static void AddFallbackServices(this IServiceCollection services)
    {
        ...
        // NaGet's services have multiple implementations that live side-by-side.
        ...
        //    container. This is the strategy used by applications that embed NaGet.
        ...
        //    by the default NaGet application.
        //
        // NaGet has database and search services, but the database services are special
