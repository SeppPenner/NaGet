...
public class SymbolIndexingService : ISymbolIndexingService
{
    ...
    private readonly ISymbolStorageService storage;
    private readonly ILogger<SymbolIndexingService> logger;
    ...
    private bool AreSymbolFilesValid(IReadOnlyList<string> entries)
    {
        ...
        bool IsValidSymbolFileInfo(FileInfo file)
        {
            ...
            if (!ValidSymbolPackageContentExtensions.Contains(file.Extension))
            {
                return false;
            }
