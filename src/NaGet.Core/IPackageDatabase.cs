...
public interface IPackageDatabase
{
    ...
    Task<PackageAddResult> Add(Package package, CancellationToken cancellationToken);
    ...
    Task<IReadOnlyList<Package>> Find(string id, bool includeUnlisted, CancellationToken cancellationToken);
    ...
    /// <param name="cancellationToken">A token to cancel the task.</param>
    /// <returns>Whether the package exists in the database.</returns>
    Task<bool> Exists(string id, NuGetVersion version, CancellationToken cancellationToken);
    ...
    Task<bool> UnlistPackage(string id, NuGetVersion version, CancellationToken cancellationToken);
    ...
    /// <param name="cancellationToken">A token to cancel the task.</param>
    /// <returns>False if the package does not exist.</returns>
    Task<bool> RelistPackage(string id, NuGetVersion version, CancellationToken cancellationToken);
    ...
    Task AddDownload(string id, NuGetVersion version, CancellationToken cancellationToken);
    ...
    Task<bool> HardDeletePackage(string id, NuGetVersion version, CancellationToken cancellationToken);
}

/// <summary>
/// The result of attempting to add the package to the database.
/// See <see cref="IPackageDatabase.Add(Package, CancellationToken)"/>
/// </summary>
