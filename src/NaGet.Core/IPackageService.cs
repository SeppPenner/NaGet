...
public interface IPackageService
{
    ...
    /// </returns>
    Task<IReadOnlyList<NuGetVersion>> FindPackageVersions(string id, CancellationToken cancellationToken);
    ...
    /// </returns>
    Task<IReadOnlyList<Package>> FindPackages(string id, CancellationToken cancellationToken);
    ...
    /// </returns>
    Task<Package?> FindPackageOrNull(string id, NuGetVersion version, CancellationToken cancellationToken);
    ...
    /// <param name="cancellationToken">A token to cancel the task.</param>
    Task AddDownload(string packageId, NuGetVersion version, CancellationToken cancellationToken);
}
