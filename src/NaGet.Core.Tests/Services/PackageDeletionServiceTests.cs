...
namespace NaGet.Core.Tests.Services
{
    public class PackageDeletionServiceTests
    {
        ...
        private readonly NaGetOptions _options;
        ...
        public PackageDeletionServiceTests()
        {
            ...
            _options = new NaGetOptions();

            var optionsSnapshot = new Mock<IOptionsSnapshot<NaGetOptions>>();
        ...
        public async Task WhenUnlist_ReturnsTrueOnlyIfPackageExists(bool packageExists)
        {
            ...
            _packages
                .Setup(p => p.UnlistPackage(PackageId, PackageVersion, cancellationToken))
            ...
            _packages.Verify(
                p => p.UnlistPackage(PackageId, PackageVersion, cancellationToken),
                Times.Once);

            _packages.Verify(
                p => p.HardDeletePackage(It.IsAny<string>(), It.IsAny<NuGetVersion>(), It.IsAny<CancellationToken>()),
                Times.Never);
            _storage.Verify(
        ...
        public async Task WhenHardDelete_ReturnsTrueOnlyIfPackageExists(bool packageExists)
        {
            ...
            _packages
                .Setup(p => p.HardDeletePackage(PackageId, PackageVersion, cancellationToken))
            ...
            _packages.Verify(
                p => p.HardDeletePackage(PackageId, PackageVersion, cancellationToken),
                Times.Once);
            _storage.Verify(
            ...
            _packages.Verify(
                p => p.UnlistPackage(It.IsAny<string>(), It.IsAny<NuGetVersion>(), It.IsAny<CancellationToken>()),
                Times.Never);
        }
    }
}
