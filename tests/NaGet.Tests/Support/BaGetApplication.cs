...
namespace NaGet.Tests
{
    public class NaGetApplication : WebApplicationFactory<Startup>
    {
        ...
        protected override void ConfigureWebHost(IWebHostBuilder builder)
        {
            ...
            var sqlitePath = Path.Combine(tempPath, "NaGet.db");
            ...
            builder
                ...
                {
                    // NaGet uses console logging by default. This logger throws operation
    ...
    internal static class NaGetWebApplicationFactoryExtensions
    {
