...
namespace NaGet.Core.Tests.Metadata
{
    ...
    {
        /// <summary>
        /// NaGet extends the NuGet protocol to add more functionality.
        ...
        /// "NaGet.Protocol" project. These tests ensure that the duplicates
        ...
        public static IEnumerable<object[]> ExtendedModelsData()
        {
            yield return new object[]
            {
                new ExtendedModelData
                {
                    ...
                    DerivedType = typeof(NaGetRegistrationIndexResponse),
                    ...
                    {
                        {
                            ...
                            (
                                ...
                                To: typeof(IReadOnlyList<NaGetRegistrationIndexPage>)
                            )
                        },
                    }
                }
            ...
            yield return new object[]
            {
                new ExtendedModelData
                {
                    ...
                    DerivedType = typeof(NaGetRegistrationIndexPage),
                    ...
                    {
                        {
                            ...
                            (
                                ...
                                To: typeof(IReadOnlyList<NaGetRegistrationIndexPageItem>)
                            )
                        },
                    }
                }
            ...
            yield return new object[]
            {
                new ExtendedModelData
                {
                    ...
                    DerivedType = typeof(NaGetRegistrationIndexPageItem),
